...
function periodWindow(now: number, period: BoardPeriod) {
...
export function useRaceClock(period: BoardPeriod): RaceClock | null {
...
export function RaceCountdownBoxes({ period }: { period: BoardPeriod }) {
  const race = useRaceClock(period);
